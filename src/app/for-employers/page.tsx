...
export default function ForEmployersPage() {
    return (
        <Container maxWidth="lg" sx={{ py: 5, textAlign: 'center' }}>
            <Paper sx={{ py: 10, px: 10, borderRadius: "20px" }}>
                <Stack sx={{ alignItems: "center" }}>
                    ...
                    <Stack sx={{ mt: 4, mb: 3, alignItems: "center" }}>
                        <Typography variant="h5" sx={{ fontWeight: 500 }}>
                            Atrakcyjne warunki publikacji ogłoszeń
                        </Typography>
                        <Typography variant="body1" color="text.secondary" sx={{ mt: 1.5, fontWeight: 500 }}>
                            U nas możesz publikować ogłoszenia w przedziale od 5 do 90 dni już od 1.33 zł/dzień.
                        </Typography>
                    </Stack>
